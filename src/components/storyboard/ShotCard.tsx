...
export const ShotCard = ({ shotNumber }: ShotCardProps) => {
  ...
  return (
    <>
      <Card className="bg-dark-lighter border-none p-4 hover:bg-dark-card transition-colors duration-200 w-[300px] flex-shrink-0">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select>
              <SelectTrigger className="bg-black/20 border-0 focus:ring-1 focus:ring-primary mt-2">
          ...
          <div>
            ...
            <div className="relative">
              <Input 
                ...
                className="bg-black/20 border-0 focus-visible:ring-1 focus-visible:ring-primary pr-10 mt-2"
              />
              <Button 
                size="icon" 
                variant="ghost" 
